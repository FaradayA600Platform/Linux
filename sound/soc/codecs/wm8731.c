				 ...
				 enum snd_soc_bias_level level)
{
	...
	case SND_SOC_BIAS_STANDBY:
		 ...
		 * wm8731 on A380 evb. The wm8731 codec driver in Linux gates
		 * CLKOUT by default. We need to apply this patch or there will
		 * be no external clock.
		 */
		snd_soc_component_write(component, WM8731_PWR, reg & 0x003f);
#else
...
static int wm8731_hw_init(struct device *dev, struct wm8731_priv *wm8731)
{
	...
	/* 
	 * Dante 2011.05.11
	 * I need this to make it work on Faraday A369
	 */
	regmap_write(wm8731->regmap, WM8731_APANA, 0x15);
#else
