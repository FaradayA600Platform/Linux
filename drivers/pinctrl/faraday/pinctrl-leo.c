...
static const unsigned ftgpio010_pins[] = {
	LEO_PIN_X_LC_PCLK,       //GPIO[0]
	LEO_PIN_X_LC_VS,         //GPIO[1]
	LEO_PIN_X_UART5_TX,      //GPIO[2] - ModeX
	LEO_PIN_X_UART5_RX,      //GPIO[3] - ModeX

#if 1 //20200602@BC: GPIO[4]~GPIO[5] signals can output to below two PAD sets.
      //             User must to choose one PAD set that depend on the EVB design.
	LEO_PIN_X_LC_DATA_0,     //GPIO[4]
	LEO_PIN_X_LC_DATA_1,     //GPIO[5]
#else
	LEO_PIN_X_UART6_RX,      //GPIO[4]
	LEO_PIN_X_UART9_TX,      //GPIO[5]
#endif

	LEO_PIN_X_LC_DATA_2,     //GPIO[6]
	LEO_PIN_X_LC_DATA_3,     //GPIO[7]

#if 1 //20200602@BC: GPIO[8] signals can output to below two PAD.
      //             User must to choose one PAD set that depend on the EVB design.
	LEO_PIN_X_LC_DATA_4,     //GPIO[8]
#else
	LEO_PIN_X_UART9_RX,      //GPIO[8]
#endif

#if 1 //20200602@BC: GPIO[9]~GPIO[10] signals can output to below two PAD sets.
      //             User must to choose one PAD set that depend on the EVB design.
	LEO_PIN_X_MII_RX_CK,     //GPIO[9]
	LEO_PIN_X_MII_RXD_2,     //GPIO[10]
#else
	LEO_PIN_X_UART8_TX,      //GPIO[9]
	LEO_PIN_X_UART8_RX,      //GPIO[10]
#endif

#if 1 //20200602@BC: GPIO[11] signal can output to below three PAD.
      //             User must to choose one PAD set that depend on the EVB design.
	LEO_PIN_X_LC_DATA_7,     //GPIO[11]
#elif 0
	LEO_PIN_X_MII_RXD_3,     //GPIO[11]
#else
	LEO_PIN_X_UART8_RX_h,    //GPIO[11]
#endif

#if 1 //20200602@BC: GPIO[12]~GPIO[16] signals can output to below two PAD sets.
      //             User must to choose one PAD set that depend on the EVB design.
	LEO_PIN_X_LC_DATA_8,     //GPIO[12]
	LEO_PIN_X_LC_DATA_9,     //GPIO[13]
	LEO_PIN_X_LC_DATA_10,    //GPIO[14]
	LEO_PIN_X_LC_DATA_11,    //GPIO[15]
	LEO_PIN_X_LC_DATA_12,    //GPIO[16]
#else
	LEO_PIN_X_MII_TX_CK,     //GPIO[12]
	LEO_PIN_X_MII_TX_ER,     //GPIO[13]
	LEO_PIN_X_MII_TXD_2,     //GPIO[14]
	LEO_PIN_X_MII_TXD_3,     //GPIO[15]
	LEO_PIN_X_MII_CRS,       //GPIO[16]
#endif

	LEO_PIN_X_LC_DATA_6,     //GPIO[17] - ModeX
	LEO_PIN_X_I2S0_TXD,      //GPIO[18] - ModeX
	LEO_PIN_X_UART2_NRTS,    //GPIO[19] - ModeX
	LEO_PIN_X_UART2_NCTS,    //GPIO[20] - ModeX
	LEO_PIN_X_LC_DATA_5,     //GPIO[21] - ModeX
	LEO_PIN_X_I2S0_RXD,      //GPIO[22] - ModeX
	LEO_PIN_X_I2S0_SCLK,     //GPIO[23] - ModeX
	LEO_PIN_X_MII_TX_EN,     //GPIO[24] - ModeX
	LEO_PIN_X_I2S0_FS,       //GPIO[25] - ModeX
	LEO_PIN_X_RMII0_RXD_0,   //GPIO[26] - ModeX
	LEO_PIN_X_LC_DATA_23,    //GPIO[27]
	LEO_PIN_X_I2S_MCLK,      //GPIO[28]
	LEO_PIN_X_UART7_TX,      //GPIO[29] - ModeX
	LEO_PIN_X_UART7_RX,      //GPIO[30] - ModeX
	LEO_PIN_X_MII_MDC,       //GPIO[31]
};
#else
static const unsigned ftgpio010_pins[] = {
	...
	LEO_PIN_X_LC_PCLK,       //GPIO[0]
	LEO_PIN_X_LC_VS,         //GPIO[1]
	LEO_PIN_X_LC_HS,         //GPIO[2]
	LEO_PIN_X_LC_DE,         //GPIO[3]
	LEO_PIN_X_LC_DATA_0,     //GPIO[4]
	LEO_PIN_X_LC_DATA_1,     //GPIO[5]
	LEO_PIN_X_LC_DATA_2,     //GPIO[6]
	LEO_PIN_X_LC_DATA_3,     //GPIO[7]
	LEO_PIN_X_LC_DATA_4,     //GPIO[8]
#else
	LEO_PIN_X_UART5_TX,      //GPIO[0]
	LEO_PIN_X_UART5_RX,      //GPIO[1]
	LEO_PIN_X_UART5_RX_h,    //GPIO[2]
	LEO_PIN_X_UART6_TX,      //GPIO[3]
	LEO_PIN_X_UART6_RX,      //GPIO[4]
	LEO_PIN_X_UART9_TX,      //GPIO[5]
	LEO_PIN_X_UART7_TX,      //GPIO[6]
	LEO_PIN_X_UART7_RX,      //GPIO[7]
	LEO_PIN_X_UART9_RX,      //GPIO[8]
#endif

#if 1 //20200525@BC: GPIO[9]~GPIO[11] signals can output to below three PAD sets.
      //             User must to choose one PAD set that depend on the EVB design.
	LEO_PIN_X_LC_DATA_5,     //GPIO[9]
	LEO_PIN_X_LC_DATA_6,     //GPIO[10]
	LEO_PIN_X_LC_DATA_7,     //GPIO[11]
#elif 0
	LEO_PIN_X_MII_RX_CK,     //GPIO[9]
	LEO_PIN_X_MII_RXD_2,     //GPIO[10]
	...
	LEO_PIN_X_MII_TXD_3,     //GPIO[15]
	LEO_PIN_X_MII_CRS,       //GPIO[16]
	LEO_PIN_X_MII_COL,       //GPIO[17]
#endif

      //20200525@BC: GPIO[18]~GPIO[31] always output to below PADs.
	LEO_PIN_X_LC_DATA_14,    //GPIO[18]
	LEO_PIN_X_LC_DATA_15,    //GPIO[19]
	LEO_PIN_X_LC_DATA_16,    //GPIO[20]
	LEO_PIN_X_LC_DATA_17,    //GPIO[21]
	LEO_PIN_X_LC_DATA_18,    //GPIO[22]
	LEO_PIN_X_LC_DATA_19,    //GPIO[23]
	LEO_PIN_X_LC_DATA_20,    //GPIO[24]
	LEO_PIN_X_LC_DATA_21,    //GPIO[25]
	LEO_PIN_X_LC_DATA_22,    //GPIO[26]
	LEO_PIN_X_LC_DATA_23,    //GPIO[27]
	LEO_PIN_X_I2S_MCLK,      //GPIO[28]
	LEO_PIN_X_SPI_DCX1,      //GPIO[29]
	LEO_PIN_X_SPI_DCX2,      //GPIO[30]
	LEO_PIN_X_MII_MDC,       //GPIO[31]
};
#endif
static const unsigned ftgpio010_1_pins[] = {
	  //20200525@BC: GPIO[0] always output to below PAD.
	LEO_PIN_X_EMMC1_D7,      //GPIO[0]

#if 1 //20200525@BC: GPIO[1]~GPIO[4] signals can output to below two PAD sets.
      //             User must to choose one PAD set that depend on the EVB design.
	LEO_PIN_X_EMMC1_D6,      //GPIO[1]
	LEO_PIN_X_EMMC1_D5,      //GPIO[2]
	LEO_PIN_X_EMMC1_D4,      //GPIO[3]
	LEO_PIN_X_EMMC1_D3,      //GPIO[4]
#elif 0
	LEO_PIN_X_MII_RX_CK,     //GPIO[1]
	LEO_PIN_X_MII_RXD_2,     //GPIO[2]
	LEO_PIN_X_MII_RXD_3,     //GPIO[3]
	LEO_PIN_X_MII_TX_CK,     //GPIO[4]
#endif

#if 1 //20200525@BC: GPIO[5]~GPIO[10] signals can output to below two PAD sets.
      //             User must to choose one PAD set that depend on the EVB design.
	LEO_PIN_X_EMMC1_D2,      //GPIO[5]
	LEO_PIN_X_EMMC1_D1,      //GPIO[6]
	LEO_PIN_X_EMMC1_D0,      //GPIO[7]
	LEO_PIN_X_EMMC1_RSTN,    //GPIO[8]
	LEO_PIN_X_EMMC1_CMD,     //GPIO[9]
	LEO_PIN_X_EMMC1_CLK,     //GPIO[10]
#elif 0
	LEO_PIN_X_RMII0_TXD_0,   //GPIO[5]
	LEO_PIN_X_RMII0_TXD_1,   //GPIO[6]
	LEO_PIN_X_RMII0_TX_EN,   //GPIO[7]
	LEO_PIN_X_RMII0_RX_CRSDV,//GPIO[8]
	LEO_PIN_X_RMII0_RX_ER,   //GPIO[9]
	LEO_PIN_X_RMII0_RXD_0,   //GPIO[10]
#endif

#if 1 //20200525@BC: GPIO[11]~GPIO[14] signals can output to below three PAD sets.
      //             User must to choose one PAD set that depend on the EVB design.
	LEO_PIN_X_UART9_RX,      //GPIO[11]
	LEO_PIN_X_UART8_TX,      //GPIO[12]
	LEO_PIN_X_UART8_RX,      //GPIO[13]
	LEO_PIN_X_UART8_RX_h,    //GPIO[14]
#elif 0
	LEO_PIN_X_RMII0_RXD_1,   //GPIO[11]
	LEO_PIN_X_RMII0_REF_CLK, //GPIO[12]
	LEO_PIN_X_RMII0_MDC,     //GPIO[13]
	LEO_PIN_X_RMII0_MDIO,    //GPIO[14]
#else
	LEO_PIN_X_I2S0_FS,       //GPIO[11]
	LEO_PIN_X_I2S0_RXD,      //GPIO[12]
	LEO_PIN_X_I2S0_SCLK,     //GPIO[13]
	LEO_PIN_X_I2S0_TXD,      //GPIO[14]
#endif

#if 1 //20200525@BC: GPIO[15]~GPIO[18] signals can output to below two PAD sets.
      //             User must to choose one PAD set that depend on the EVB design.
	LEO_PIN_X_MII_TX_ER,     //GPIO[15]
	LEO_PIN_X_MII_TXD_2,     //GPIO[16]
	LEO_PIN_X_MII_TXD_3,     //GPIO[17]
	LEO_PIN_X_MII_CRS,       //GPIO[18]
#else
	LEO_PIN_X_RGMII_RX_CK,   //GPIO[15]
	LEO_PIN_X_RGMII_RXD_0,   //GPIO[16]
	LEO_PIN_X_RGMII_RXD_1,   //GPIO[17]
	LEO_PIN_X_RGMII_RXD_2,   //GPIO[18]
#endif

#if 1 //20200525@BC: GPIO[19] can output to below three PAD.
	LEO_PIN_X_MII_COL,       //GPIO[19]
#elif 0
	LEO_PIN_X_RGMII_RXD_3,   //GPIO[19]
#else
	LEO_PIN_X_RGMII_TXD_0,   //GPIO[19]
#endif

#if 1 //20200525@BC: GPIO[20]~GPIO[22] signals can output to below two PAD sets.
      //             User must to choose one PAD set that depend on the EVB design.
	LEO_PIN_X_RGMII_RXCTL,   //GPIO[20]
	LEO_PIN_X_RGMII_GTX_CK,  //GPIO[21]
	LEO_PIN_X_RGMII_TXCTL,   //GPIO[22]
#else
	LEO_PIN_X_RGMII_TXD_1,   //GPIO[20]
	LEO_PIN_X_RGMII_TXD_2,   //GPIO[21]
	LEO_PIN_X_RGMII_TXD_3,   //GPIO[22]
#endif

#if 1 //20200525@BC: GPIO[23]~GPIO[26] signals can output to below two PAD sets.
      //             User must to choose one PAD set that depend on the EVB design.
	LEO_PIN_X_MII_TXD_0,     //GPIO[23]
	LEO_PIN_X_MII_TXD_1,     //GPIO[24]
	LEO_PIN_X_MII_MDC,       //GPIO[25]
	LEO_PIN_X_MII_MDIO,      //GPIO[26]
#else
	LEO_PIN_X_RGMII_MDC,     //GPIO[23]
	LEO_PIN_X_RGMII_MDIO,    //GPIO[24]
	LEO_PIN_X_MII_TX_EN,     //GPIO[25]
	LEO_PIN_X_MII_RX_DV,     //GPIO[26]
#endif

	  //20200525@BC: GPIO[27]~GPIO[29] always output to below PADs.
	LEO_PIN_X_MII_RX_ER,     //GPIO[27]
	LEO_PIN_X_MII_RXD_0,     //GPIO[28]
	LEO_PIN_X_MII_RXD_1,     //GPIO[29]
};
...
static const unsigned ftpwmtmr010_pins[] = {
	LEO_PIN_X_LC_DATA_0,        //tmr1_out

#if 1 //20200601@BC: tmr2_out signal can output to below three PADs.
      //             User must to choose one PAD that depend on the EVB design.
	LEO_PIN_X_LC_DATA_1,        //tmr2_out
#elif 0
	LEO_PIN_X_I2S0_FS,          //tmr2_out
#else
	LEO_PIN_X_UART5_RX_h,       //tmr2_out
#endif

#if 1 //20200601@BC: tmr3_out signal can output to below six PADs.
      //             User must to choose one PAD that depend on the EVB design.
	LEO_PIN_X_LC_DATA_2,        //tmr3_out
#elif 0
	LEO_PIN_X_I2S0_RXD,         //tmr3_out
#elif 0
	LEO_PIN_X_UART8_RX_h,       //tmr3_out
#elif 0
	LEO_PIN_X_MII_MDC,          //tmr3_out
#elif 0
	LEO_PIN_X_RGMII_TXD_0,      //tmr3_out
#else
	LEO_PIN_X_RMII0_MDIO,       //tmr3_out
#endif

#if 1 //20200601@BC: tmr1_out signal can output to below five PADs.
      //             User must to choose one PAD that depend on the EVB design.
	LEO_PIN_X_LC_DATA_3,        //tmr4_out
#elif 0
	LEO_PIN_X_I2S0_SCLK,        //tmr4_out
#elif 0
	LEO_PIN_X_MII_MDIO,         //tmr4_out
#elif 0
	LEO_PIN_X_RGMII_TXD_1,      //tmr4_out
#else
	LEO_PIN_X_EMMC1_CLK,        //tmr4_out
#endif
};
static const unsigned ftpwmtmr010_1_pins[] = {
#if 0 //20200601@BC: tmr1_out signal can output to below two PADs.
      //             User must to choose one PAD that depend on the EVB design.
	LEO_PIN_X_I2S0_TXD,         //tmr1_out
#else
	LEO_PIN_X_RGMII_TXD_2,      //tmr1_out
#endif
	LEO_PIN_X_RGMII_TXD_3,      //tmr2_out
	LEO_PIN_X_RGMII_MDC,        //tmr3_out
	LEO_PIN_X_RGMII_MDIO,       //tmr4_out
};
static const unsigned ftpwmtmr010_2_pins[] = {
	LEO_PIN_X_RMII0_TXD_0,      //tmr1_out
	LEO_PIN_X_RMII0_TXD_1,      //tmr2_out
	LEO_PIN_X_RMII0_TX_EN,      //tmr3_out
	LEO_PIN_X_RMII0_RX_CRSDV,   //tmr4_out
};
static const unsigned ftpwmtmr010_3_pins[] = {
	LEO_PIN_X_RMII0_RXD_0,      //tmr1_out
	LEO_PIN_X_RMII0_RX_ER,      //tmr2_out
};
...
static struct ftscu010_pin leo_pinmux_map[] = {
	...
	LEO_PIN(X_MII_MDIO,			MFS153,	FTGMAC030_MII,		FTGPIO010_1,	NA,				NA,				FTPWMTMR010,	NA,				NA,				NA),
	...
	LEO_PIN(X_I2S_MCLK,			MFS183,	FTSSP010_I2S,		FTSSP010_I2S_1,	FTGPIO010,		NA,				NA,				NA,				NA,				NA),
