			     ...
			     unsigned long clk_freq)
{
	...
	ret = request_irq(irq, ftpwmtmr010_clockevent_interrupt,
				IRQF_TIMER | IRQF_IRQPOLL, "ftpwmtmr010", &ftpwmtmr010_clkevt);
	if (ret) {
...
TIMER_OF_DECLARE(ftpwmtmr010, "faraday,ftpwmtmr010", ftpwmtmr010_of_init);
